...
The challenge is based on two components:

1. `VectorBlox`: You can view the manual [here](https://github.com/riscvarchive/riscv-4th-workshop-tutorials/tree/master/vectorblox_tutorial)!
2. [`simon`](https://github.com/openluopworld/block-ciphers/tree/master/simon): A lightweight block cipher.

The code was not stripped to help with understanding and checking the manual.
...
Flag: `SEKAI{y4y_u_p4ss3d_ScR4TcHp4D_t35t_w1th_V3ct0rB10x_4nd_51M0N_xD}`