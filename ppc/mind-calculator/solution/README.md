...
1. Run speech recognition against the received audio. Word-for-word recognition is preferred, this is to minimize misconversions of numbers by the speech recognition engine.
...
(or you could totally do it manually!)

Here is the solve using [`vosk-model-en-us-0.22-lgraph`](https://alphacephei.com/vosk/models) (requires some luck, as accuracy can be low):
...
Here is the solve with [Azure Speech](https://azure.microsoft.com/en-us/services/cognitive-services/speech-services/):
...
- [Vosk](https://alphacephei.com/vosk/models) (model: `vosk-model-en-us-0.22-lgraph`):
  - Speed: ~5sec./question
  - Accuracy: ~85%
- [Azure Speech](https://azure.microsoft.com/en-us/services/cognitive-services/speech-services/):
  - Speed: ~20sec./question
  - Accuracy: ~92%
